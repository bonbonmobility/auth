...
func (ts *ResendTestSuite) TestResendSuccess() {
	...
	require.NoError(ts.T(), models.CreateOneTimeToken(ts.API.db, phoneUser.ID, phoneUser.GetEmailChange(), phoneUser.GetEmailChangeTokenNew(), models.EmailChangeTokenNew))
	...
	require.NoError(ts.T(), models.CreateOneTimeToken(ts.API.db, phoneUser.ID, phoneUser.GetPhoneChange(), phoneUser.GetPhoneChangeToken(), models.PhoneChangeToken))
